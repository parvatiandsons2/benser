...
urlpatterns = [
    ...
    path("services/", views.items, name="items"),
    path("services/category/<str:url>/", views.items_by_category, name="items_by_category"),
    path("service-details/<str:url>/", views.item_details, name="item_details"),
